/**
 * v0 by Vercel.
 * @see https://v0.dev/t/3GxgAcOz8a9
 */
"use client";
      ...
      <div className="flex flex-col">
        <header className="flex h-14 lg:h-[60px] items-center gap-4 border-b bg-gray-100/40 px-6 dark:bg-gray-800/40">
          ...
          <div className="flex items-center gap-4">
            <Button className="ml-auto text-sm font-medium bg-blue-500 text-white rounded px-2 py-1">
              Earn $$$
            </Button>
              ...
              <DropdownMenuTrigger asChild>
                ...
                >
                  <Avatar>
                    <AvatarImage
                      alt="Avatar"
                      className="rounded-full text-blue-500 bg-blue-500"
                      height="32"
